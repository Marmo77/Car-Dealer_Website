...
const CarCard = (car: Car) => {
  return (
    <Card className="group max-md:w-full py-0 gap-3 not-odd:-translate-y-3 bg-card shadow-lg border-none hover:md:scale-105 transition-transform duration-200 overflow-hidden rounded-xl">
